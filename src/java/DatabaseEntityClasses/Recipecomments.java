...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Recipecomments.findAll", query = "SELECT r FROM Recipecomments r")
    , @NamedQuery(name = "Recipecomments.findByRecipeid", query = "SELECT r FROM Recipecomments r WHERE r.recipecommentsPK.recipeid = :recipeid")
    , @NamedQuery(name = "Recipecomments.findByCommentnum", query = "SELECT r FROM Recipecomments r WHERE r.recipecommentsPK.commentnum = :commentnum")
    , @NamedQuery(name = "Recipecomments.findByCommenttext", query = "SELECT r FROM Recipecomments r WHERE r.commenttext = :commenttext")})
